...
/*!
  \file
  \ingroup  optimizer
  \brief    Declaration of class iOptimizerMLP
*/

#ifndef IOPTIMIZERMLP_HH
#define IOPTIMIZERMLP_HH 1
...
*/
class iOptimizerMLP : public vOptimizer
{
  // -----------------------------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iOptimizerMLP::iOptimizerMLP()
      \brief   The constructor of iOptimizerMLP
    ...
    */
    ...
    /*!
      \fn      public iOptimizerMLP::~iOptimizerMLP()
      \brief   The destructor of iOptimizerMLP
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerMLP)
    /*!
      \fn      public int iOptimizerMLP::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iOptimizerMLP::ReadOptionsList()
      \param   const string& a_configurationFile
  ...
  private:
    ...
    /*!
      \fn      private int iOptimizerMLP::PreImageUpdateSpecificStep()
  ...
  private:
    /*!
      \fn      private void iOptimizerMLP::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerMLP::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerMLP::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerMLP::SensitivitySpecificOperations()
      \param   FLTNB a_data
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerMLP::DataSpaceSpecificOperations()
      \param   FLTNB a_data
      \param   FLTNB a_forwardModel
    ...
    */
    int DataSpaceSpecificOperations( FLTNB a_data, FLTNB a_forwardModel, FLTNB* ap_backwardValues,
                                     ...
                                     FLTNB a_quantificationFactor, oProjectionLine* ap_Line );
    /*!
      \fn      private int iOptimizerMLP::ImageSpaceSpecificOperations()
...
CLASS_OPTIMIZER(MLP,iOptimizerMLP)
