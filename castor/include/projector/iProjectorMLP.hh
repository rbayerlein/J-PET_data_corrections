...
/*!
  \file
  \ingroup  projector
  \brief    Declaration of class iProjectorMLP
*/

#ifndef IPROJECTORMLP_HH
#define IPROJECTORMLP_HH 1
...
/*!
  \class   iProjectorMLP
  \brief   This class is a child of the vProjector class implementing the MLP projector
  \details This class implements the MLP algorithm which is a Most Likely Position algorithm.
*/
class iProjectorMLP : public vProjector
{
  // -------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iProjectorMLP::iProjectorMLP()
      \brief   The constructor of iProjectorMLP
    ...
    */
    ...
    /*!
      \fn      public iProjectorMLP::~iProjectorMLP()
      \brief   The destructor of iProjectorMLP
  ...
  public:
    ...
    FUNCTION_PROJECTOR( iProjectorMLP )
    /*!
      \fn      public int iProjectorMLP::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iProjectorMLP::ReadOptionsList()
      \param   const string& a_configurationFile
  ...
  private:
    /*!
      \fn      private void iProjectorMLP::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iProjectorMLP::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iProjectorMLP::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iProjectorMLP::ProjectWithoutTOF()
    ...
    */
    ...
    /*!
      \fn      private int iProjectorMLP::ProjectTOFListmode()
      \param   int a_direction
      \param   oProjectionLine* ap_ProjectionLine
    ...
    */
    ...
    /*!
      \fn      private int iProjectorMLP::ProjectTOFHistogram()
      \param   int a_direction
      \param   oProjectionLine* ap_ProjectionLine
...
CLASS_PROJECTOR( mlp, iProjectorMLP )
