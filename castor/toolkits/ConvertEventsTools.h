...
class ConvertEventsTools
{
  public:
    ...
    static uint32_t getCastorID(float x, float y, float z, const std::vector<std::tuple<float, float, float>> &castorIDs, const float scintillatorLength, const float crystalSizeZ);
};
