...
dir_base = '/media/rbayerlein/SSD_006_Img/Image_data/J-PET/Simulation_data/NEMA_IQ_9_to_1';

% u-map
fname_umap = '/media/rbayerlein/SSD_006_Img/Image_data/J-PET/Simulation_data/9_to_1_nema_umap_resampled.img';
tx_fov = 509.147; % mm

% activity map

dir_amaps_in = '/media/rbayerlein/SSD_006_Img/Image_data/J-PET/Simulation_data/';
amap_name = '9_to_1_recon_att_delayed_it4.img';
...
% binaries paths
simset_path = '/home/rbayerlein/Code/Recon/jPET/';
...
num_threads_avail = (maxNumCompThreads-2)*2;    % should leave a few empty to prevent lagging. 
num_threads_per_frame = num_threads_avail;
num_to_simulate = 2500000000 ; % number of decays to simulate in total
...
cd ../amap_processing/
fname_amaps_in = [dir_amaps_in, '/', amap_name];
